    ...
    <section id="features" className="relative z-10 pt-12 pb-28 border-t border-main/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg md:text-xl text-main/50 max-w-2xl mx-auto font-medium">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/*  Expiry */}
          <div className="group bg-white p-10 rounded-lg border border-main/15 hover:border-theme/20 hover:cursor-pointer transition-all duration-300 shadow-[0_4px_20px_rgb(0,0,0,0.02)] hover:shadow-[0_20px_40px_rgba(167,214,233,0.1)] cursor-default">
            <div className="w-14 h-14 rounded-2xl bg-cream flex items-center justify-center mb-6 border border-theme/20 group-hover:scale-110 transition-transform duration-300">
              <Calendar className="w-6 h-6 text-primary" />
            </div>
            <h3 className="text-xl font-bold text-main mb-3 font-heading">Expiry Tracking</h3>
            <p className="text-main/60 leading-relaxed text-sm font-medium">
          ...
          {/*  Scanning  */}
          <div className="group bg-white p-10 rounded-lg border border-main/15 hover:border-theme/20 hover:cursor-pointer transition-all duration-300 shadow-[0_4px_20px_rgb(0,0,0,0.02)] hover:shadow-[0_20px_40px_rgba(167,214,233,0.1)] relative overflow-hidden cursor-default">
